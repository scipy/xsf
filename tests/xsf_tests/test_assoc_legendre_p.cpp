...
TEST_CASE("assoc_legendre_p scipy/gh-23101", "[assoc_legendre_p][xsf_tests]") {
    ...
    auto [n, m, z, ref, rtol] = GENERATE(
        test_case{1, 0, -1.0, -1.0, 1e-15},
	test_case{1, 0, std::nextafter(-1.0, -2.0), -1.0000000000000002, 1e-15},
	test_case{1, 0, std::nextafter(-1.0, 0.0), -0.9999999999999999, 1e-15},
	test_case{2, 0, -1.0, 1.0, 1e-15},
	test_case{2, 0, std::nextafter(-1.0, -2.0), 1.0000000000000007, 1e-15},
	test_case{2, 0, std::nextafter(-1.0, 0.0), 0.9999999999999997, 1e-15},
	test_case{3, 0, -1.0, -1.0, 1e-15},
	test_case{3, 0, std::nextafter(-1.0, -2.0), -1.0000000000000013, 1e-15},
	test_case{3, 0, std::nextafter(-1.0, 0.0), -0.9999999999999993, 1e-15},
	test_case{4, 0, -1.0, 1.0, 1e-15},
