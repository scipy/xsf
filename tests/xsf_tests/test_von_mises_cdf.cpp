...
TEST_CASE("von Mises CDF test", "[von_mises_cdf][xsf_tests]") {
    ...
    SECTION("von Mises CDF scipy reference values") {
        ...
        auto [k, x, expected] = GENERATE(
            ...
            test_case{8.36402231256455, 7.977659725009496, 1.9999882231205492},
            ...
            test_case{71.4703644287635, 0.19632196274422142, 0.9509492993052443},
            ...
            test_case{23.163504610347342, -0.1389481133079018, 0.25318137444421307},
