...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "lgam1p"};

TEST_CASE("cephes::lgam1p d->d scipy_special_tests", "[cephes::lgam1p][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
