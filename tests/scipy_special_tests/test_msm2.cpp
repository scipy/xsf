...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "msm2"};

TEST_CASE("msm2 ddd->dd scipy_special_tests", "[msm2][ddd->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
