...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "sindg"};

TEST_CASE("sindg d->d scipy_special_tests", "[sindg][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
