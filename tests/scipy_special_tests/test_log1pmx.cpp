...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "log1pmx"};

TEST_CASE("log1pmx d->d scipy_special_tests", "[log1pmx][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
