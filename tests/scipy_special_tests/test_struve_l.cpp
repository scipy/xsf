...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "struve_l"};

TEST_CASE("struve_l dd->d scipy_special_tests", "[struve_l][dd->d][scipy_special_tests]") {
    SET_FP_FORMAT()
