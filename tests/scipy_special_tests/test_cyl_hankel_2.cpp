...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "cyl_hankel_2"};

TEST_CASE("cyl_hankel_2 dD->D scipy_special_tests", "[cyl_hankel_2][dD->D][scipy_special_tests]") {
    SET_FP_FORMAT()
