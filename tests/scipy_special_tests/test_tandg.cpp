...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "tandg"};

TEST_CASE("tandg d->d scipy_special_tests", "[tandg][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
