...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "zetac"};

TEST_CASE("zetac d->d scipy_special_tests", "[zetac][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
