...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "struve_h"};

TEST_CASE("struve_h dd->d scipy_special_tests", "[struve_h][dd->d][scipy_special_tests]") {
    SET_FP_FORMAT()
