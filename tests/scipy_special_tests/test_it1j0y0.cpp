...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "it1j0y0"};

TEST_CASE("it1j0y0 d->dd scipy_special_tests", "[it1j0y0][d->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
