...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "sem_cva"};

TEST_CASE("sem_cva dd->d scipy_special_tests", "[sem_cva][dd->d][scipy_special_tests]") {
    SET_FP_FORMAT()
