...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "sem"};

TEST_CASE("sem ddd->dd scipy_special_tests", "[sem][ddd->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
