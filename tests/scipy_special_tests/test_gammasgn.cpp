...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "gammasgn"};

TEST_CASE("gammasgn d->d scipy_special_tests", "[gammasgn][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
