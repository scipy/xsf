...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "it1i0k0"};

TEST_CASE("it1i0k0 d->dd scipy_special_tests", "[it1i0k0][d->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
