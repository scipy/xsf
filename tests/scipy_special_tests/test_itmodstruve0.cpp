...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "itmodstruve0"};

TEST_CASE("itmodstruve0 d->d scipy_special_tests", "[itmodstruve0][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
