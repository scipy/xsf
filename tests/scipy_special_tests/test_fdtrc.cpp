...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "fdtrc"};

TEST_CASE("fdtrc ddd->d scipy_special_tests", "[fdtrc][ddd->d][scipy_special_tests]") {
    SET_FP_FORMAT()
