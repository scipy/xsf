...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "it2struve0"};

TEST_CASE("it2struve0 d->d scipy_special_tests", "[it2struve0][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
