...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "pbvv"};

TEST_CASE("pbvv dd->dd scipy_special_tests", "[pbvv][dd->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
