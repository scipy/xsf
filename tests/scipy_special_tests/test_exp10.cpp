...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "exp10"};

TEST_CASE("exp10 d->d scipy_special_tests", "[exp10][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
