...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "exprel"};

TEST_CASE("exprel d->d scipy_special_tests", "[exprel][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
