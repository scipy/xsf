...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "kolmogi"};

TEST_CASE("kolmogi d->d scipy_special_tests", "[kolmogi][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
