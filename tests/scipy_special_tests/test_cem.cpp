...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "cem"};

TEST_CASE("cem ddd->dd scipy_special_tests", "[cem][ddd->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
