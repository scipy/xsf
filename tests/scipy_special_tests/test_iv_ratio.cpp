...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "iv_ratio"};

TEST_CASE("iv_ratio dd->d scipy_special_tests", "[iv_ratio][dd->d][scipy_special_tests]") {
    SET_FP_FORMAT()
