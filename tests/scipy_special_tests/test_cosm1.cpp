...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "cosm1"};

TEST_CASE("cosm1 d->d scipy_special_tests", "[cosm1][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
