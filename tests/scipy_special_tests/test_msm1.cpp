...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "msm1"};

TEST_CASE("msm1 ddd->dd scipy_special_tests", "[msm1][ddd->dd][scipy_special_tests]") {
    SET_FP_FORMAT()
