...
fs::path tables_path{fs::path(XSREF_TABLES_PATH) / "scipy_special_tests" / "itstruve0"};

TEST_CASE("itstruve0 d->d scipy_special_tests", "[itstruve0][d->d][scipy_special_tests]") {
    SET_FP_FORMAT()
