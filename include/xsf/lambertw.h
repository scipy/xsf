...
namespace detail_complex {
    ...
    XSF_HOST_DEVICE inline std::complex<double> lambertw_impl(std::complex<double> z, long k, double tol) {
        double absz;
        ...
        if (k == 0) {
            if (std::abs(z + EXPN1) < 0.3) {
                w = detail_complex::lambertw_branchpt(z);
                ...
                * approximation is more accurate. */
                w = detail_complex::lambertw_pade0(z);
            } else {
                w = detail_complex::lambertw_asy(z, k);
            }
        } else if (k == -1) {
...
XSF_HOST_DEVICE inline std::complex<double> lambertw(std::complex<double> z, long k, double tol) {
    return detail_complex::lambertw_impl(z, k, tol);
}

XSF_HOST_DEVICE inline std::complex<float> lambertw(std::complex<float> z, long k, float tol) {
    return static_cast<std::complex<float>>(detail_complex::lambertw_impl(static_cast<std::complex<double>>(z), k, static_cast<double>(tol))
    );
}
...
namespace detail_real {
    ...
    constexpr double P1[] = {+7.7365760093772431000E-5, +2.3753035787333611915E-2,
    ...
    constexpr double P2[] = {+2.5106760479132851033E-5, +3.3062485753746403559E-3,
    ...
    constexpr double P3[] = {+3.3723373020306510843E-8, +1.6072263556502220023E-5,
    ...
    constexpr double P4[] = {+1.4348813778416631453E-11, +2.5623503144117723217E-8,
    ...
    constexpr double P5[] = {+2.8447049039139409652E-15, +1.9384214479606474749E-11,
    ...
    constexpr double P6[] = {+3.7052997281721724439E-19, +9.7650889714265294606E-15,
    ...
    constexpr double P7[] = {+3.8232862205660283978E-23, +3.9433033758391036653E-18,
    ...
    constexpr double P8[] = {+3.3768973150742552802E-27, +1.3780424091017898301E-21,
    ...
    constexpr double P9[] = {+2.6422433422088187549E-31, +4.3101698455492225750E-25,
    ...
    constexpr double P10[] = {+1.8665089270660122398E-35, +1.2288944126268109432E-28,
    ...
    constexpr double P11[] = {+1.2054662641251783155E-39, +3.2324944691435843553E-32,
    ...
    constexpr double P12[] = {+7.1845890343701668760E-44, +7.9138276083474522931E-36,
    ...
    constexpr double P13[] = {+3.9807997764326166245E-48, +1.8157173553077986962E-39,
    ...
    constexpr double P14[] = {+2.0629086382257737517E-52, +3.9259872712305770430E-43,
    ...
    constexpr double P15[] = {+1.0049140812146492611E-56, +8.0372997176526840184E-47,
    ...
    constexpr double P16[] = {+4.6216193040664872606E-61, +1.5640423898448433548E-50,
    ...
    constexpr double P17[] = {+2.0141870458566179853E-65, +2.9029638696956315654E-54,
    ...
    constexpr double P18[] = {+9.0194147766309957537E-12, +1.2363066058921706716E-8,
    ...
    constexpr double P19[] = {+9.8419790334279711453E-16, +7.0890325988973812656E-12,
    ...
    constexpr double Pm1[] = {+4.6423885014099583351E-15, -2.5025242885340438533E-11,
        +3.4316085386913786410E-8, -1.5748033750499977208E-5, +2.5155722460763844737E-3,
        -1.2519345387558783223E-1, +1.3696658805421383765, -1.2742179703075440564
        +8.0974347786703195026E-2, -7.0254996087870332289E-1, +1
    };
    constexpr double Qm3[] = {+3.1153673308133671452E-12, -1.7909312066865957905E-6,
        +3.9405862890608636876E-4, -2.1720009380176605969E-2, +3.8480980098588483913E-1,
        -2.1249449707404812847, +2.3699648912703015610, +1
    };
    constexpr double Qm4[] = {+1.7199220185947756654E+27, +1.1575146167513516225E+25,
        +1.3879041239716289478E+22, +5.0311809576499530281E+18, +6.4456135373410289079E+14,
        +2.9211518136900492046E+10, +401820.46666230725328E+5, +1
    };
    constexpr double Qm5[] = {+1.1397589139790739717E+23, +3.0510432205608900949E+21,
        +1.4464907902386074496E+19, +2.0704349060120443049E+16, +1.0469617416664402757E+13,
        +1.8728545945050381188E+9, +1.0171286771760620046E+5, +1
    };
    constexpr double Qm6[] = {+8.4166620643385013384E+18, +8.8371323861233504533E+17,
        +1.6314734740054252741E+16, +9.0772608163810850446E+13, +1.7832922702470761113E+11,
        +1.2393087277442041494E+8, +2.6154955236499142433E+4, +1
    };
    constexpr double Qm7[] = {+7.1210136651525477096E+14, +2.8699933268233923842E+14,
        +2.0234381161638084359E+13, +4.2929807417453196113E+11, +3.2146028239685694655E+9,
        +8.5153001025466544379E+6, +6.8525813734431100971E+3, +1
    };
    constexpr double Qm8[] = {+7.1964698876049131992E+10, +1.0770866639543156165E+11,
        +2.8254232485273698021E+10, +2.2304011314443083969E+9, +6.2149181398465483037E+7,
        +6.1284097585595092761E+5, +1.8370770693017166818E+3, +1
    };
    constexpr double Qm9[] = {+9.1959100987983855122E+6, +4.8982268956208830876E+7,
        +4.6142116445258015195E+7, +1.3111690693712415242E+7, +1.3168304640091436297E+6,
        +4.6852747159777876192E+4, +5.0740525628523300801E+2, +1
    };
    constexpr double Qm10[] = {+1.6416808960330370987E+3, +2.9531165406571745340E+4,
        +9.4918733120470346165E+4, +9.2441293717108619527E+4, +3.1912693749754847460E+4,
        +3.9124761372539240712E+3, +1.4636315161669567659E+2, +1
    };
    constexpr double Pm05[] = {-3.4636746512247457319E-1, +3.9303608629539851049,
        -1.3015133123886661124E+1, +1.7084773793345271001E+1, -6.8442842200833309724,
        -4.0991407924007457612, +4.2963016178777127009, −1.0000000000000001110
    };
    constexpr double Qm05[] = {-5.3875778140352599789E-2, +1.1978786762794003545,
        -7.0580758756624790550, +1.8249006287190617068E+1, -2.4446872319343475890E+1,
        +1.7740962374121397994E+1, -6.6279455994747624059, +1
    };

    XSF_HOST_DEVICE inline double rational_function(double x, const double A[], int nA, const double B[], int nB) {
        double numerator = evalpoly(A, nA, x);
        double denominator = evalpoly(B, nB, x);
    ...
    XSF_HOST_DEVICE inline double lambertw_impl(double z, long k) {
