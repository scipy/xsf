...
extern "C" int main() {
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    double tol = 1e-13;
    double a_true[6] = {
			-1.802532491522514e+02,
			-1.412800568086200e+02,
			-1.033705070649672e+02,
			-66.574389967485317,
			-30.950104000623185,
			3.432562047992776
    };
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    double b_true[6] = {
			-1.802532491522514e+02,
			-1.412800568086194e+02,
			-1.033705070649312e+02,
			-66.574389965842357,
			-30.950103947238059,
			3.432563359324842
    };
  ...
  N = 5;
  {
    ...
    double tol = 1e-13;
    double AA_true[5] = {
			 6.72989672316633203e-01,
			 -3.06303580036475842e-01,
			 1.86455593633495648e-02,
			 -5.11683638542392003e-04,
  ...
  printf("----------------------------------------------\n");  
  {
    ...
    m = 1;
    double AA_true[5] = {
			 9.90202059407947477e-01,
			 -1.39511476750210750e-01,
			 6.03431870922933183e-03,
			 -1.28040356069675752e-04,
  ...
  printf("----------------------------------------------\n");
  {
    ...
    m = 2;
    double AA_true[5] = {
			 2.16927946751974854e-01,
			 9.48257346823881631e-01,
			 -8.17670087238141774e-02,
			 2.58658716581847224e-03,
  ...
  printf("----------------------------------------------\n");
  {
    ...
    m = 3;
    double AA_true[5] = {
			 1.39615654604830663e-01,
			 9.88251100137287120e-01,
			 -6.21675551357310924e-02,
			 1.55778240472689887e-03,
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    m = 1;
    double AA_true[5] = {
			 9.93967961398935729e-01,
			 -1.09583791872267272e-01,
			 4.36764886689439396e-03,
			 -8.89579207045385789e-05,
  ...
  printf("----------------------------------------------\n");
  {
    ...
    m = 2;
    double AA_true[5] = {
			 9.96571915618007398e-01,
			 -8.26907809217511391e-02,
			 2.57874176092240956e-03,
			 -4.29271107568478840e-05,
			 4.46771248032548085e-07,
    };
  ...
  printf("----------------------------------------------\n");
  {
    ...
    m = 3;
    double AA_true[5] = {
			 1.09642473301236554e-01,
			 9.92016510230659843e-01,
			 -6.22843393799822065e-02,
			 1.55951158907772385e-03,
  ...
  printf("----------------------------------------------\n");
  {
    ...
    m = 4;
    double AA_true[5] = {
			 8.27162782989298156e-02,
			 9.95322502016357302e-01,
			 -4.99004143812368725e-02,
			 1.04056488398845915e-03,
  ...
  N = 6;
  {
    ...
    double mc1_true[6] = {
			  -3.43416995264759106e-01,
			  3.97873130174148326e-01,
			  8.35567375774955712e-02,
			  3.15168992451903213e-03,
			  4.36682920825898135e-05,
			  2.91722697679619490e-07
    };
    double mc1d_true[6] = {
			   2.32628352485249795e-01,
			   -1.37343635827296445e-01,
			   4.09262446440566696e-01,
			   2.69766257109354118e-02,
			   5.19428246083634753e-04,
			   4.40526164453159552e-06
    };
    ...
    for (int i = 0; i<N; i++) {
      ...
      printf("Iteration i = %d, order m = %d, v = %f, mc1 = %20.17e,      mc1d = %20.17e\n",
	     i, m, v, mc1, mc1d);
      printf("                                        mc1_true = %20.17e, mc1d_true = %20.17e\n",
	     mc1_true[i], mc1d_true[i]);
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    // I use widely spaced orders to verify adaption works OK.
    double mc1_true[6] = {
			  -3.41428322016207667e-02,
			  3.44948654167566600e-03,
			  3.35219048366175096e-02,
			  -9.08021166319475555e-03,
			  -3.24223338845559816e-02,
			  1.27646351014092524e-02
    };
    double mc1d_true[6] = {
			   2.00691110743774284e-02,
			   1.85469526520107095e+01,
			   -3.57255502109930578e+00,
			   -1.79656659177568585e+01,
			   5.87447048444966935e+00,
			   1.72822185411075182e+01
    };
  ...
  N = 6;
  {
    ...
    // m = 1, 4, 7, 10, 13, 16
    double ms1_true[6] = {
			  -3.43379253985569288e-01,
			  3.97873130174058565e-01,
			  8.35567375774849824e-02,
			  3.15168992462108635e-03,
			  4.36682920825898135e-05,
			  2.91722697679619490e-07
    };
    double ms1d_true[6] = {
			   2.29156633917084712e-01,
			   -1.37343635825750598e-01,
			   4.09262446440550431e-01,
			   2.69766257110715633e-02,
			   5.19428246083634753e-04,
			   4.40526164453159637e-06
    };
    ...
    for (int i = 0; i<N; i++) {
      ...
      printf("Iteration i = %d, order m = %d, v = %f, ms1 = %20.17e,      ms1d = %20.17e\n",
	     i, m, v, ms1, ms1d);
      printf("                                        ms1_true = %20.17e, ms1d_true = %20.17e\n",
	     ms1_true[i], ms1d_true[i]);
      // For small 1 modmc1's output is very small.  To adequately test, I check
      // both the absolute err as well as the rel error.  I get one failure
      // which suggests some minute difference between Matlab and C imps.
      // The difference occurs because of catastrophic cancellation, but
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    // m = 1, 4, 7, 10, 13, 16
    double ms1_true[6] = {
			  -3.41201739333336501e-02,
			  2.33952744720816123e-03,
			  3.36955475281936756e-02,
			  -8.29453993546177236e-03,
			  -3.24933710575481122e-02,
			  1.27631677399401809e-02
    };
    double ms1d_true[6] = {
			   -6.45251275907079758e-01,
			   1.85996271072809449e+01,
			   -3.04135814724805620e+00,
			   -1.80792391857584605e+01,
			   5.75576271594593436e+00,
			   1.72825425245382398e+01
    };
  ...
  N = 6;
  {
    ...
    // I use widely spaced orders to verify adaption works OK.
    double mc2_true[6] = {
			  -1.05364049460497881e-02,
			  -5.43273917516489124e-02,
			  -8.98079478272420850e-01,
			  -1.21204986957549021e+01,
			  -6.18466504094926336e+02,
			  -7.25758230510118883e+04
    };
    double mc2d_true[6] = {
			   -1.84664333620107901e+00,
			   1.61881073394890906e+00,
			   3.22020193455027437e+00,
			   9.82487563907863120e+01,
			   7.22196427512374794e+03,
			   1.08632040247457405e+06
    };
    ...
    for (int i = 0; i<N; i++) {
      ...
      printf("Iteration i = %d, order m = %d, v = %f, mc2 = %20.17e,      mc2d = %20.17e\n",
	     i, m, v, mc2, mc2d);
      printf("                                        mc2_true = %20.17e, mc2d_true = %20.17e\n",
	     mc2_true[i], mc2d_true[i]);
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    // I use widely spaced orders to verify adaption works OK.
    double mc2_true[6] = {
			  -5.50400810104661117e-06,
			  -3.39713077181867523e-02,
			  6.51339805952160303e-03,
			  3.29219862870713670e-02,
			  -1.07334892119392861e-02,
			  -3.16798833654585860e-02
    };
    double mc2d_true[6] = {
			   -1.86457777769476074e+01,
			   1.90043837315601305e+00,
			   1.82970001977819763e+01,
			   -4.97283180832788130e+00,
			   -1.76904663568990372e+01,
			   6.98187640938441945e+00
    };
  ...
  N = 6;
  {
    ...
    // m = 1, 4, 7, 10, 13, 16
    double ms2_true[6] = {
			  -9.91337437572497975e-03,
			  -5.43273917519763866e-02,
			  -8.98079478272391984e-01,
			  -1.21204986957547884e+01,
			  -6.18466504094926336e+02,
			  -7.25758230510119029e+04,
    };
    double ms2d_true[6] = {
			   -1.84736861502861638e+00,
			   1.61881073394918618e+00,
			   3.22020193455016246e+00,
			   9.82487563907851893e+01,
			   7.22196427512374976e+03,
			   1.08632040247457428e+06,
    };
    ...
    for (int i = 0; i<N; i++) {
      ...
      printf("Iteration i = %d, order m = %d, v = %f, ms2 = %20.17e,      ms2d = %20.17e\n",
	     i, m, v, ms2, ms2d);
      printf("                                        ms2_true = %20.17e, ms2d_true = %20.17e\n",
	     ms2_true[i], ms2d_true[i]);
  ...
  printf("----------------------------------------------\n");    
  {
    ...
    // m = 1, 4, 7, 10, 13, 16
    double ms2_true[6] = {
			  1.21267949732755992e-03,
			  -3.40647275296700053e-02,
			  5.53991666556525025e-03,
			  3.31278916985982691e-02,
			  -1.05157990917375058e-02,
			  -3.16804730008901705e-02
    };
    double ms2d_true[6] = {
			   -1.86352300142727003e+01,
			   1.29451048253596168e+00,
			   1.83932580755102961e+01,
			   -4.54427791318153673e+00,
			   -1.77295648089783491e+01,
			   6.98107651232898974e+00
    };
