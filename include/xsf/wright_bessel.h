...
XSF_HOST_DEVICE inline double wright_bessel(double a, double b, double x) { return wright_bessel_t<false>(a, b, x); }
...
XSF_HOST_DEVICE inline double log_wright_bessel(double a, double b, double x) { return wright_bessel_t<true>(a, b, x); }
