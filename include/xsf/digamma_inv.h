...
namespace detail {
    ...
    XSF_HOST_DEVICE inline double digamma_inv_initial_guess(double y) {
    ...
    XSF_HOST_DEVICE inline double digamma_inv_newton_raphson(double x, double y) {
    ...
    XSF_HOST_DEVICE inline double digamma_inv(double y) {
        // Reference:
...
XSF_HOST_DEVICE inline double digamma_inv(double y) { return detail::digamma_inv(y); }

XSF_HOST_DEVICE inline float digamma_inv(float y) {
    return static_cast<float>(detail::digamma_inv(static_cast<double>(y)));
}
