...
namespace cephes {
    ...
    namespace detail {
        ...
        constexpr int owens_t_SELECT_METHOD[] = {0,  0,  1,  12, 12, 12, 12, 12, 12, 12, 12, 15, 15, 15, 8,  0,  1,  1,
                                                 2,  2,  4,  4,  13, 13, 14, 14, 15, 15, 15, 8,  1,  1,  2,  2,  2,  4,
                                                 4,  14, 14, 14, 14, 15, 15, 15, 9,  1,  1,  2,  4,  4,  4,  4,  6,  6,
                                                 15, 15, 15, 15, 15, 9,  1,  2,  2,  4,  4,  5,  5,  7,  7,  16, 16, 16,
                                                 11, 11, 10, 1,  2,  4,  4,  4,  5,  5,  7,  7,  16, 16, 16, 11, 11, 11,
                                                 1,  2,  3,  3,  5,  5,  7,  7,  16, 16, 16, 16, 16, 11, 11, 1,  2,  3,
                                                 3,  5,  5,  17, 17, 17, 17, 16, 16, 16, 11, 11};
        ...
        constexpr double owens_t_PTS[] = {0.35082039676451715489E-02, 0.31279042338030753740E-01,
        ...
        constexpr double owens_t_WTS[] = {0.18831438115323502887E-01, 0.18567086243977649478E-01,
